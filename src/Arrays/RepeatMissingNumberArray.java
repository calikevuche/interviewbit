...
public class RepeatMissingNumberArray {
    ...
    public ArrayList<Integer> repeatedNumber1(final List<Integer> b) {
        ...
        for (int i = 0; i < a.size(); i++) {
            int position = a.get(i) - 1;
            if (!Objects.equals(a.get(position), a.get(i))) {
